...
public class NoRippleDelayClick extends MaterialNavigationDrawer {
    @Override
    public void init(Bundle savedInstanceState) {
        ...
        this.addSection(newSection("Section 4", R.drawable.ic_hotel_grey600_24dp, new FragmentButton()).setSectionColor(Color.parseColor("#03a9f4")));
